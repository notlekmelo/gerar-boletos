...
const DigitosVerificadores = require('./digito-verificador.util');
...
var Beneficiario = (function () {
	...
	Beneficiario.prototype.comDigitoNossoNumero = function (_digitoNossoNumero, banco, data) {
		...
		if(banco instanceof  Sicredi) {
			...
			this._digitoNossoNumero = DigitosVerificadores.digitoVerificadorItau(
																		this.getAgenciaFormatada(),
																		this.getConta(),
																		this.getCarteira(),
																		this.getNossoNumero()
			...
			this._digitoNossoNumero = DigitosVerificadores.digitoVerificadorBradesco(this.getCarteira(), this.getNossoNumero)
...
var Boleto = (function () {
	...
	Boleto.prototype.getFatorVencimento = function () {
		...
		if (diferencaEmDias > 9999) {
			const novaDataBase = new Date(2022, 4, 29);
			diferencaEmDias = (vencimento - novaDataBase) / (1000 * 60 * 60 * 24);
			if (diferencaEmDias < 0 || diferencaEmDias > 9999) {
